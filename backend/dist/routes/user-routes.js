...
import { getAllUsers, userSignup, userLogin, adminDashboard, manageUser, userChatHistory, userLogout, blockUser, unblockUser } from "../controllers/user-controllers.js";
import { checkBlocked, isAdmin, verifyUser } from "../middleware/middleware.js";
import { signupValidator, validate, loginValidator } from "../utils/validator.js";
